...
<form action="" method="POST" class="form-inline top-search-form float-left" id="searchForm">
    ...
    <select class="form-control form-control-sm mr-sm-2 mb-2 select2-show-search" name="supplier_id" id="search_supplier" data-placeholder="{{__('page.select_customer')}}">
